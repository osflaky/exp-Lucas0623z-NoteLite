...
The `app` sub-project handles the NoteLite application.
...
└── app
 ...
    │   ├── Primus.ttf // ...
    │   │
    │   ├── all-icons-256.ico // NoteLite icon
    │   ├── icon-256.ico // ...
    │   ├── icon-256.png // ...
    │   ├── icon-50.gif // ...
    │   ├── icon-50.png // ...
...
| :--- | :--- | :--- | 
| `project.version` | NoteLite version | 5.6.1 |
...
| `project.ext.programName` | Program name | NoteLite | 
| `project.ext.programId` | Program id | notelite | 
| `project.ext.programVersion` | Program version | `project.version` | 
| `project.ext.companyName` | Company name | NoteLite | 
| `project.ext.companyId` | Company ID | NoteLiteOrg | 
...
Note: This is useful only when the user launches the application via its `NoteLite` or `NoteLite.bat` command files.
It is no longer useful when using the new NoteLite installers
...
These icons represent the NoteLite icon in different sizes and formats.

![](./res/icon-64.png)

### Splash files

They represent the NoteLite logo in different formats.

![](./res/splash.png)

### `basic-classifier.zip`

This is the result of the training of NoteLite neural network on fixed size symbols.
