//------------------------------------------------------------------------------------------------//
//                                                                                                //
//                                 C h o r d B o w R e l a t i o n                                //
//                                                                                                //
//------------------------------------------------------------------------------------------------//
...
/**
 * Class <code>ChordBowRelation</code> represents a support relation between a chord
 * and a strings bow indication (either up or down).
 *
 * @author NoteLite Contributors
 */
@XmlRootElement(name = "chord-bow")
public class ChordBowRelation
        extends AbstractConnection
{
    ...
    {
        final BowInter bow = (BowInter) e.getEdgeTarget();
    ...
    {
        return constants.bowTargetCoeff.getValue();
    }
    ...
    private static class Constants
            extends ConstantSet
    {
        private final Constant.Ratio bowTargetCoeff = new Constant.Ratio(
                0.5,
                "Supporting coeff for (target) bow");

        private final Scale.Fraction xGapMax = new Scale.Fraction(
                0.75,
                "Maximum horizontal gap between bow center & chord");

        private final Scale.Fraction xGapMax_p1 = new Scale.Fraction(1.2, "Idem for profile 1");

        private final Scale.Fraction yGapMax = new Scale.Fraction(
                5.0,
                "Maximum vertical gap between bow center & chord");

        private final Scale.Fraction yGapMax_p1 = new Scale.Fraction(7.0, "Idem for profile 1");
    }
