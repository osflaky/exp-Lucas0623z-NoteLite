...
import com.notelite.omr.image.GaussianGrayFilter;
import com.notelite.omr.image.ImageFormatException;
import com.notelite.omr.image.ImageUtil;
import com.notelite.omr.image.MedianGrayFilter;
import com.notelite.omr.image.PixelFilter;
import com.notelite.omr.image.PixelSource;
        ...
        implements EventSubscriber<LocationEvent>
{
     ...
     * properly handled by NoteLite and adjust if needed.
     *
