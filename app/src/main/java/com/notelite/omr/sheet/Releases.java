...
/**
 * Class <code>Releases</code> handles features related to NoteLite releases.
 *
...
public abstract class Releases
{
    ...
    //------------------//
    /**
     * Retrieve the latest release available on NoteLite project site.
     *
    ...
    public static GHRelease getLatestRelease ()
    {
        try {
            ...
            logger.warn("Could not connect to NoteLite project.\n{}", ex.toString());
    ...
    //----------------//
    /**
     * Retrieve all releases available on NoteLite project site.
     *
     * @return the latest release, or null if something went wrong
     */
