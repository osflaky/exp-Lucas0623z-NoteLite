...
import com.notelite.omr.ui.util.BrowserLinkListener;
...
import com.notelite.omr.util.Version.UpgradeVersion;
 ...
 * <p>
 * It can poll NoteLite project site (GitHub) to check for availability of a more recent release
...
public abstract class Versions
{
    ...
    /** Version of current NoteLite software. */
    ...
    //------//
    /**
     * Poll the GitHub site for a new NoteLite release.
     *
    ...
    public static void poll (boolean manual)
    {
        ...
        if (latest == null) {
            logger.debug("Version check skipped (upstream NoteLite GitHub org unavailable)");
            return;
        }
