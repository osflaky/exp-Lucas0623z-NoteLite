...
/**
 * Class <code>BasicTask</code> is an Application Framework Task for NoteLite application.
 *
        ...
        extends Task<T, V>
{
    ...
    /**
     * NoteLite application is injected into this task.
     */
    public BasicTask ()
    {
