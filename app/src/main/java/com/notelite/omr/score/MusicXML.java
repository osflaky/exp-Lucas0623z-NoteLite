...
public abstract class MusicXML
{
     ...
     *
     * @param style    the NoteLite barline style
    ...
    //--------//
    /**
     * Converts from NoteLite <code>ChordNameInter.ChordKind.ChordType</code> type
     * to Proxymusic <code>KindValue</code> type.
     *
     * @param type NoteLite enum ChordSymbol.ChordType
    ...
    //--------//
    /**
     * Convert from NoteLite NoteStep type to Proxymusic NoteStep type.
     *
     * @param step NoteLite enum step
    ...
    //--------//
    /**
     * Converts from NoteLite <code>ChordNameInter.ChordDegree.DegreeType</code>
     * to Proxymusic <code>DegreeTypeValue</code>.
     *
     * @param type NoteLite enum DegreeType
