...
import com.notelite.omr.math.Rational;
import com.notelite.omr.score.DrumSet.DrumInstrument;
import com.notelite.omr.score.DrumSet.DrumSound;
import com.notelite.omr.score.DrumSet.MotifSign;
import static com.notelite.omr.score.MusicXML.*;
import com.notelite.omr.sheet.Book;
import com.notelite.omr.sheet.Part;
import com.notelite.omr.sheet.PartBarline;
import com.notelite.omr.sheet.ProcessingSwitch;
import com.notelite.omr.sheet.ProcessingSwitches;
...
import com.notelite.omr.sheet.rhythm.Slot;
import com.notelite.omr.sheet.rhythm.SlotVoice;
...
import com.notelite.omr.sig.inter.AbstractPauseInter;
...
import static com.notelite.omr.text.TextRole.*;
import com.notelite.omr.ui.symbol.TextFont;
import com.notelite.omr.util.HorizontalSide;
import static com.notelite.omr.util.HorizontalSide.*;
import com.notelite.omr.util.OmrExecutors;
import static com.notelite.omr.util.VerticalSide.*;
 ...
 * from an NoteLite {@link Score} instance.
 *
...
public class PartwiseBuilder
{
     ...
     * provided NoteLite {@link LogicalPart} instance.
     *
    ...
    private void processScore ()
    {
        try {
...

            {
                ...
                //                    scorePartwise.setMovementTitle("[NoteLite detected movement]");
                //                }
