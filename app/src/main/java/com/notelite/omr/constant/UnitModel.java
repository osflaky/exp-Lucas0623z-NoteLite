...
//------------------------------------------------------------------------------------------------//
// </editor-fold>
package com.notelite.omr.constant;
...
import com.notelite.omr.ui.treetable.AbstractTreeTableModel;
import com.notelite.omr.ui.treetable.TreeTableModel;
        ...
        extends AbstractTreeTableModel
{
    ...
    private static final ResourceMap resources = Application.getInstance().getContext()
            .getResourceMap(UnitModel.class);
    ...
    public String getColumnName (int column)
    {
        ...
        final String key = col.name() + ".header";
    ...
    public static enum Column
    {
         ...
         * defined by {@link com.notelite.omr.sheet.Scale.Fraction}.
