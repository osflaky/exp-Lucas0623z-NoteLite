...
import com.notelite.omr.classifier.ui.Trainer;
import com.notelite.omr.constant.Constant;
import com.notelite.omr.constant.ConstantSet;
import com.notelite.omr.glyph.ui.ShapeColorChooser;
import com.notelite.omr.sheet.BookManager;
import com.notelite.omr.sheet.Releases;
...
import com.notelite.omr.ui.symbol.SymbolRipper;
import com.notelite.omr.ui.util.CursorController;
        ...
        extends AbstractBean
{
    ...
    //---------------//
    /**
     * Print out information about all NoteLite releases on GitHub.
     *
     * @param e unused
     */
    @Action
    ...
    //------------//
    /**
     * Action to launch a browser on NoteLite manual
     *
     * @param e the event which triggered this action
     */
