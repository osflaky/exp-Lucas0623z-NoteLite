...
import com.notelite.omr.util.ClassUtil;
 ...
 * Typically, {@link com.notelite.omr.check.CheckBoard}'s are visible only when they carry
 * glyph information.
 * <p>
        ...
        implements EventSubscriber<UserEvent>
{
    ...
    private void defineLayout ()
    {
        ...
        component.setBorder(new TitledBorder(displayName(name)));
        component.setInsets(
    ...
    //----------------//
    /**
     * Report the localized display name (used in menus / titles).
     * Falls back to the internal name if no localization is available.
     */
    ...
    private static String displayName (String name)
    {
        ...
        final String key = "title." + name.toLowerCase().replace(' ', '_');
