...
//------------------------------------------------------------------------------------------------//
// </editor-fold>
package com.notelite.omr.text.tesseract;

import com.notelite.omr.OMR;
import static com.notelite.omr.text.Language.DEFINED_LANGUAGES;
import static com.notelite.omr.text.Language.getSupportedLanguages;
import static com.notelite.omr.text.tesseract.TesseractOCR.LANGUAGE_FILE_EXT;
import com.notelite.omr.ui.GuiActions;
