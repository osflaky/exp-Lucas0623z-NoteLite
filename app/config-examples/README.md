...
where it will be detected at runtime by the NoteLite application.
...
This file defines one or several `plugins` for the NoteLite application.

The purpose of a `plugin` is to ease the handover of some MusicXML data
from NoteLite application (the producer)
...
[plugins]: https://notelite.example.com/notelite/_pages/guides/advanced/plugins/
[user-config]: https://notelite.example.com/notelite/_pages/reference/folders/essential/#config-folder
