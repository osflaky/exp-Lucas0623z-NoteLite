...
def main(build_dir):
    ...
    # ${GRADLE_TEMP}/caches/modules-2/files-2.1/com.notelite/proxymusic/4.0.2/7a747a5b8d1e738e74abf883d9c23b0b18f0bf22/proxymusic-4.0.2.jar

    # Target dir layout:
    # dependencies/org/notelite/proxymusic/4.0.2
